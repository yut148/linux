...
echo "EMCC boot.js"
EMCC_DEBUG=1 emcc -o js/boot.html tools/lkl/tests/boot-mod2.ll -s ALLOW_MEMORY_GROWTH=1 -s EMULATE_FUNCTION_POINTER_CASTS=1 -s PTHREAD_POOL_SIZE=16 -s USE_PTHREADS=1 -v
